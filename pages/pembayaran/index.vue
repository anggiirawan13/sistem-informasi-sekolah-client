      ...
      <v-card class="my-3">
        ...
        <v-card-text>
          ...
          <div class="d-flex mb-4">
            ...
            <v-spacer></v-spacer>
            <v-btn to="/pembayaran/add" :color="$vuetify.theme.themes.dark.secondary" dark elevation="3" small
          ...
          >
              ...
              <v-dialog v-model="dialogDelete" max-width="500px">
                <v-card>
                  <v-card-title
                    ...
                    {{ itemDelete.nama_pembayaran }}?</v-card-title
                  >
                  <v-card-actions>
                    <v-spacer></v-spacer>
            ...
            <template v-slot:item.actions="{ item }">
              <v-btn :to="`/pembayaran/edit/${item.id}`" icon :color="$vuetify.theme.themes.dark.info"
  ...
  mounted() {
    if (this.$route.params.message) {
      ...
      this.message = this.$t(this.$route.params.message, {
        title: this.$route.params.nama_pembayaran,
      });
    }
  },
};
